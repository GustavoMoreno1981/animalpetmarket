...
-- ==================== 20260910103500_blindar_datos_criticos ====================
create or replace function crear_pedido_transaccional(
  p_nombre_cliente text,
  p_telefono text,
  p_direccion text,
...
-- ==================== 20260907114056_valor_domicilio_pedidos ====================
...
-- ==================== 20260907112757_proteger_catalogo_con_restrict ====================
alter table subcategorias
  drop constraint if exists subcategorias_categoria_id_fkey;
alter table subcategorias
  add constraint subcategorias_categoria_id_fkey
...
-- ==================== 20260905183655_permitir_tarjeta_metodo_pago ====================
alter table pedidos
  drop constraint if exists pedidos_metodo_pago_check;

alter table pedidos
  add constraint pedidos_metodo_pago_check
  check (metodo_pago in ('efectivo', 'codigo_qr', 'tarjeta'));

comment on column pedidos.metodo_pago is 'Método de pago contra entrega. Valores permitidos: efectivo, codigo_qr, tarjeta.';
